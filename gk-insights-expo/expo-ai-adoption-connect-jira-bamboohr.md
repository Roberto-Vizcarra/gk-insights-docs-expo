...
Change Failure Rate (CFR) is a DORA stability metric — see [Change Failure Rate (CFR)](/gk-insights/ai-adoption-dora-metrics#change-failure-rate-cfr) for what it measures and how to read it. Setting it up here is what powers the CFR cards on /ai-adoption/ai-impact, board-metrics, and executive.
...
Once connected, time off feeds into the metrics described in [For Admins](/gk-insights/ai-adoption-for-admins).
