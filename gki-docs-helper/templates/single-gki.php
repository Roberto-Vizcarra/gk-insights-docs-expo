...
<main class="gki-layout" id="gki-layout">
  ...
  <aside class="gki-sidebar gki-sidebar--left" role="navigation" aria-label="<?php esc_attr_e( 'Insights documentation', 'gki-docs-helper' ); ?>">
    <nav class="gki-nav" id="gki-nav">
      ...
      ?>
      <!-- Theme toggle slider at bottom of nav -->
      <div class="gki-theme-switch-wrap">
        <label class="gki-theme-switch" id="gki-theme-toggle" title="Toggle dark mode">
          <input type="checkbox" aria-label="Toggle dark mode">
          <span class="gki-theme-slider">
  ...
  <aside class="gki-sidebar gki-sidebar--right" role="complementary" aria-label="<?php esc_attr_e( 'On this page', 'gki-docs-helper' ); ?>"><?php // Theme toggle moved to left nav ?>
    <?php if ( ! $is_index ) : ?>
